...
### Please review
- The [Explained attack: Cross-site scripting (XSS) in this guide](/attacks_explained/cross-site_scripting_xss)
    - [Reflected XSS](/attacks_explained/cross-site_scripting_xss#reflected-xss)
    - [Stored XSS](/attacks_explained/cross-site_scripting_xss#stored-xss)
    - [DOM XSS](/attacks_explained/cross-site_scripting_xss#dom-xss)
- The [Explained attack: Cross Site Request Forgery (CSRF) in this guide](/attacks_explained/cross_site_request_forgery_csrf)
- The [Explained attack: Server-Side Request Forgery (SSRF) in this guide](/attacks_explained/server-side_request_forgery_ssrf)
