...
- The software is out of date or vulnerable (see [A9:2017-Using
  Components with Known Vulnerabilities](/owasp-top-10/a9_using_components_with_known_vulnerabilities)).
...
- A task to review and update the configurations appropriate to
  ...
  Known Vulnerabilities](/owasp-top-10/a9_using_components_with_known_vulnerabilities)). In particular, review cloud storage
