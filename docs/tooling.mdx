...
This section is a selection of relevant tools for cybersecurity, but check out the following [awesome lists](https://github.com/sindresorhus/awesome) in order to get a most complete list of tools:
...
- [mongo-sanitizer](https://github.com/vkarpov15/mongo-sanitize) sanitizer to prevent MongoDB Operator Injection
...
- [express-mongo-sanitize](https://github.com/fiznool/express-mongo-sanitize) Middleware to prevent MongoDB Injection
