...
- [Content Security Policy](/http_headers/content_security_policy)
- [Cross Domain Policies](/http_headers/crossdomain)
- [DNS Prefetch Control](/http_headers/dns_prefetch_control)
- [Don't Sniff Mimetype](/http_headers/sniff_mimetype)
- [Expect Certificate Transparency](/http_headers/expect_ct)
- [Feature Policy](/http_headers/feature_policy)
- [Frameguard](/http_headers/frameguard)
- [Strict Transport Security](/http_headers/hsts)
- [IE No Open](/http_headers/ie_no_open)
- [Powered by](/http_headers/powered_by)
- [Referrer Policy](/http_headers/referrer_policy)
- [XSS Filter](/http_headers/xss_filter)
...
- ✅ [DNS Prefetch Control](/http_headers/dns_prefetch_control)
- ✅ [Frameguard](/http_headers/frameguard)
- ✅ [Hide powered by](/http_headers/powered_by)
- ✅ [Strict Transport Security](/http_headers/hsts)
- ✅ [IE No Open](/http_headers/ie_no_open)
- ✅ [Don't Sniff Mimetype](/http_headers/sniff_mimetype)
- ✅ [XSS Filter](/http_headers/xss_filter)
...
Optional: you need to have a report URL in order to monitor the violations of [Expect Certificate Transparency](/http_headers/expect_ct#the-code) performed by old browsers
...
The most powerful headers for security are [Feature Policy](/http_headers/feature_policy) and [Content Security Policy](/http_headers/content_security_policy) as they will define what content source (images, js, css..) or features (xhr, geolocation, iframes...) is allowed to be part of our application. 
