...
### Scenario #1: [Credential stuffing](https://github.com/danielmiessler/SecLists), the use of [lists of known passwords](https://github.com/danielmiessler/SecLists), is a common attack. If an application does not
...
- [🐑 NodeGoat A2 - Injection](https://nodegoat.herokuapp.com/tutorial/a2)
