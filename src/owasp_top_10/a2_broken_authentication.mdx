...
- You cna use Authentication headers if you are using JWT or similar 
...
Extra:
- Check the documentation for HTTP headers in this guide.
- Check the details about Strict Transport Security (HSTS) in this guide.
