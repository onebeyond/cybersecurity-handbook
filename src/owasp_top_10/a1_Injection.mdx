...
src="https://www.youtube.com/embed/9CnpHT5Nn8c">
</iframe>
...
A very extended way to exploit this vulnerability is using Cross-site scripting (XSS) attacks. Please [check out the specific entry for XSS in this manual](/attacks_explained/cross-site_scripting_xss)
