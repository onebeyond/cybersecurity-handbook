...
- Use generators for projects like [generator-systemic](https://github.com/onebeyond/generator-systemic) or [create-react-app](https://github.com/facebook/create-react-app).
