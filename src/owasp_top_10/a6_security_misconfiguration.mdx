...
src="https://www.youtube.com/embed/JuGSUMtKTPU">
</iframe>
...
Such flaws frequently give attackers
...
Components with Known Vulnerabilities](/owasp/a9_using_components_with_known_vulnerabilities)).
...
Known Vulnerabilities](/owasp/a9_using_components_with_known_vulnerabilities)). In particular, review cloud storage
...
- Use generators for projects like [generator-systemic](https://github.com/guidesmiths/generator-systemic) or [create-react-app](https://github.com/facebook/create-react-app).
...
### Scenario #4: 
A cloud service provider has default sharing
...
- [🐐 NodeGoat | A6 Security Misconfiguration](https://nodegoat.herokuapp.com/tutorial/a6)
- [🧃 Pwning OWASP Juice Shop | A6 Security Misconfiguration](https://pwning.owasp-juice.shop/part2/security-misconfiguration.html)
