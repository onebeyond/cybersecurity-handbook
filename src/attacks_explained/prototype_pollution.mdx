...
It is a technical attack that requires a great understanding on JS internals like `__proto__`, `prototype`, [deep|shadow copy](https://we-are.bookmyshow.com/understanding-deep-and-shallow-copy-in-javascript-13438bad941c?gi=a658f8d5292b).

This bug was very extended in popular libraries [like Lodash](https://snyk.io/blog/snyk-research-team-discovers-severe-prototype-pollution-security-vulnerabilities-affecting-all-versions-of-lodash/).
